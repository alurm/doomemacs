...
Doom's LSP support and install a supported LSP server.
...
3. Install [[https://emacs-lsp.github.io/lsp-mode/page/languages/][a supported LSP server]] on your system using your OS package manager
